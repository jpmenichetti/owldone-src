...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "detail.movedTo": "Moved to {name}",
    "todos.error.moveFailed": "Failed to move todo",
    ...
    "workspace.makeDefault": "Set as default",
    "workspace.placeholder": "Workspace name",
    "workspace.menuAria": "Workspace options for {name}",
    "workspace.createTitle": "Create workspace",
    "workspace.createDescription": "Workspaces keep your todos, archive, and reports separated. Tags are shared across all workspaces.",
    "workspace.renameTitle": "Rename workspace",
    "workspace.deleteTitle": "Delete workspace?",
    "workspace.deleteDescription": "This permanently deletes \"{name}\" and all its tasks, archive, and reports. Tags used only here will be removed. This cannot be undone.",
    "workspace.deleteConfirm": "Delete workspace",
    "workspace.created": "Workspace \"{name}\" created",
    "workspace.deleted": "Workspace deleted",
    "workspace.defaultSet": "Default workspace updated",
  ...
  es: {
    ...
    "filter.deleteTag": "Eliminar etiqueta {tag}",
    "filter.deleteTagConfirmTitle": "¿Eliminar etiqueta?",
    "filter.deleteTagConfirmBody": "¿Quitar la etiqueta \"{tag}\" de todas las tareas? Se eliminará de todas las tareas activas y archivadas y no se puede deshacer.",
    "filter.tagDeleted": "Etiqueta \"{tag}\" eliminada",
    ...
    "detail.workspace": "Espacio de trabajo",
    "detail.movedTo": "Movida a {name}",
    "todos.error.moveFailed": "Error al mover la tarea",
  ...
  fr: {
    ...
    "filter.deleteTag": "Supprimer le tag {tag}",
    "filter.deleteTagConfirmTitle": "Supprimer le tag ?",
    "filter.deleteTagConfirmBody": "Retirer le tag « {tag} » de toutes les tâches ? Il sera supprimé de toutes les tâches actives et archivées et cette action est irréversible.",
    "filter.tagDeleted": "Tag « {tag} » supprimé",
    ...
    "detail.workspace": "Espace de travail",
    "detail.movedTo": "Déplacée vers {name}",
    "todos.error.moveFailed": "Échec du déplacement de la tâche",
  ...
  de: {
    ...
    "filter.deleteTag": "Tag {tag} löschen",
    "filter.deleteTagConfirmTitle": "Tag löschen?",
    "filter.deleteTagConfirmBody": "Tag '{tag}' aus allen Aufgaben entfernen? Er wird aus allen aktiven und archivierten Aufgaben gelöscht und kann nicht wiederhergestellt werden.",
    "filter.tagDeleted": "Tag '{tag}' gelöscht",
    ...
    "detail.workspace": "Arbeitsbereich",
    "detail.movedTo": "Verschoben nach {name}",
    "todos.error.moveFailed": "Aufgabe konnte nicht verschoben werden",
